...
.links a{{display:inline-block;margin:.35rem .75rem .35rem 0;color:#0f766e;font-weight:600}}
ol{{padding-left:1.25rem}} code{{background:#e2e8f0;padding:.1rem .35rem;border-radius:4px}}
